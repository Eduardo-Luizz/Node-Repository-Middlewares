...
// TODO ver melhor maneira de tratar esse erro
function checksCreateTodosUserAvailability(request, response, next) {
  ...
  // let size = Object.keys(user.todos).length; // não pode passar de 10 todos cadastrados
  // if( size != 10 && user.pro === false ) {
  //   return next();
  // } else {
  //   return response.status(403).json({ error: 'Passou de 10 todos' });
  // }
}
